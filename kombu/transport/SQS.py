...
class Channel(virtual.Channel):
    ...
    def _receive_message(
        ...
        :return: SQS client receive_message
        """
    ...
    def is_sts_token_refresh_required(
        ...
        elif expire_time.replace(tzinfo=None) < datetime.utcnow():
            return True
...
class _SnsSubscription:
    ...
    def __init__(self, sns_fanout: _SnsFanout):
        self.sns = sns_fanout
