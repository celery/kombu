...
class test_Channel:
    ...
    def test_init(self):
        ...
        assert channel._registered is True
        assert channel.global_keyprefix == hash_tag
        assert channel.unacked_mutex_key == hash_tag + 'unacked_mutex'
        assert channel.unacked_index_key == hash_tag + 'unacked_index'
        assert channel.unacked_key == hash_tag + 'unacked'
