...
- The 'amqp' transport alias will now use :mod:`librabbitmq`
  if installed.
    ...
    librabbitmq will not be used if running under eventlet/gevent.

.. `py-librabbitmq`: https://github.com/celery/librabbitmq
...
- Redis: Improved implementation of Ack emulation.

    This improvement reduces the possibility of data loss.
