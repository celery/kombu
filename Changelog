...
3.0.36
======
:release-date: 2016-09-30 03:06 P.M PST
...
- Redis: Adds the ability to set more Redis connection options
  using ``Connection(transport_options={...})``.
    ...
    - ``socket_connect_timeout`` (requires :mod:`redis-py` 2.10 or later)
    - ``socket_keepalive`` (requires :mod:`redis-py` 2.10 or later)
    - ``socket_keepalive_options`` (requires :mod:`redis-py` 2.10 or later)
